...
echo "Creating shared Storage Account ${ENV_PREFIX}storage"
...
az cdn endpoint create -n $CDN_PROFILE_NAME --profile-name $CDN_PROFILE_NAME --origin $STORAGE_ACCOUNT.z21.web.core.windows.net --origin-host-header $STORAGE_ACCOUNT.z21.web.core.windows.net --enable-compression
